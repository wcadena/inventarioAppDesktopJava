...
public class OAuth2Details {
    ...
    public String toString() {
        return "OAuth2Details{" + "scope=" + scope + ", grantType=" + grantType + ", clientId=" + clientId + ", clientSecret=" + clientSecret + ", accessToken=" + accessToken + ", refreshToken=" + refreshToken + ", username=" + username + ", password=" + password + ", authenticationServerUrl=" + authenticationServerUrl + ", resourceServerUrl=" + resourceServerUrl + ", isAccessTokenRequest=" + isAccessTokenRequest + '}';
    }
